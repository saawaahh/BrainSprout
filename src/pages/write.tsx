      ...
      <section className="mt-32 flex flex-col justify-center gap-10">
        ...
        >
          <textarea
            cols={30}
            rows={10}
            className="font-montserrat mx-auto rounded-sm border border-slate-800 bg-teal-950 p-5 text-gray-50 tracking-wide md:w-1/2"
          ...
          <button
            type="submit"
            className="font-poppins mx-auto w-2/3 whitespace-pre-line rounded-sm bg-gradient-to-br from-teal-900 to-teal-950 py-3 text-xl font-bold text-gray-50 md:w-1/2"
          >
            Submit Entry
          </button>
        </form>
